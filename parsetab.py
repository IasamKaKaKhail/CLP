...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','parser.py',114),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','parser.py',118),
  ('expression -> term','expression',1,'p_expression_term','parser.py',122),
  ('term -> term TIMES factor','term',3,'p_term_times','parser.py',126),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','parser.py',130),
  ('term -> factor','term',1,'p_term_factor','parser.py',134),
  ('factor -> NUMBER','factor',1,'p_factor_number','parser.py',138),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser.py',142),
]
